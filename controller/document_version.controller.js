var Document = require("../models/document_version.model");
...
async function getAllDocument_version(user, filter) {
...
async function getDocument_versionById(id) {
...
async function createDocument_version(document, user) {
...
async function updateDocument_version(document, user) {
...
async function deleteDocument_version(id, user) {
...
module.exports = {
  getAllDocument_version,
  getDocument_versionById,
  createDocument_version,
  updateDocument_version,
  deleteDocument_version,
  filter,
};
